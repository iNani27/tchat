...
if (isset($_POST['lelogin']) && isset($_POST['lemdp'])) {
    ...
    $req = $connection->prepare("SELECT id, lelogin, lemail, avatar FROM utilisateur WHERE lelogin = '$lelogin' AND mdp = '$lemdp' ");
        ...
        <div class="connexion">
            ...
            <div class="connect one-login">
                ...
                <form method="POST" action="" name="form">
                    <ul>
                        <li>
                            <input id="lelogin" type="text" name="lelogin" value="login" onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Login';
                                    }" required/><a href="#" class=" icon user"></a> 
                        </li>
                        <li>
                            <input id="lemdp" type="password" name="lemdp" value="mot de passe" onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Mot de pass';
                                    }" required/><a href="#" class=" icon kumba"></a> 
                        </li> 
                    </ul>   
                    <div class="version-2">
